...
use bevy::render::render_resource::{AsBindGroup, RenderPipelineDescriptor, Shader, ShaderRef, SpecializedMeshPipelineError};
...
pub fn load_voxel_chunk_shader(app: &mut App) {
    load_internal_asset!(
        app,
